...
import { Swords, Trophy, Clock, Target, ChevronDown, TrendingUp, TrendingDown } from 'lucide-react';
...
export default function TeamHistory() {
  ...
  const winTrendData = teamHistory ? [{
                  ...
                  <div className="pt-4 border-t border-esports-border/30">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-blue-400 font-semibold">
                        {formatPercent(
                          teamHistory.matchHistory.slice(0, 5).filter(m => m.winner === team1).length / 5
                        )}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-green-400 font-semibold">
                        {formatPercent(
                          teamHistory.matchHistory.slice(0, 5).filter(m => m.winner === team2).length / 5
                        )}
                      </span>
                    </div>
                  </div>
